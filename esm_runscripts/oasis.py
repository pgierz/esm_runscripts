class oasis:
    ...
    def add_output_file(self, lefts, rights, leftmodel, rightmodel, config):
        ...
        for thisfile in out_file:
            ...
            config["outdata_sources"][thisfile] = (
                config["thisrun_outdata_dir"] + "/" + thisfile
            )
    ...
    def add_restart_files(self, restart_file, fconfig):
        ...
        config["restart_out_sources"][restart_file] = (
            config["thisrun_restart_out_dir"] + "/" + restart_file
        )
        config["restart_out_sources"][restart_file + "_recv"] = (
            config["thisrun_restart_out_dir"] + "/" + restart_file + "_recv"
        )
        ...
        if not restart_file in config["restart_in_sources"]:
            config["restart_in_sources"][restart_file] = (
                config["parent_restart_dir"] + "/" + restart_file
            )
